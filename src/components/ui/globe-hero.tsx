...
const GlobeDemo = () => {
  return (
    <div className="flex flex-row items-center justify-center py-5 md:py-20 min-h-[600px] md:h-[50vh] dark:bg-black relative w-full ">
      <div className="max-w-7xl mx-auto w-full relative h-[600px] px-4 overflow-hidden">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
